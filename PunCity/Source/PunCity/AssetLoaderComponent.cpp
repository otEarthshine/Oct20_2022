...
//	}
	...
	addCardIcon(CardEnum::SavannaGrasslandHerder, "GrassFed");
	addCardIcon(CardEnum::SavannaGrasslandRoamer, "GrasslandRoamer");
	...
	LoadResource2(ResourceEnum::IronTools, "SteelTools/SteelTools");
	...
	LoadResource2(ResourceEnum::Carpet, "Carpet/Carpet");
...
FMargin UAssetLoaderComponent::GetFXSpineMargin(USpineAtlasAsset* fxAtlas)
{
	if (fxAtlas == Arrow_SpineAtlasFX) return FMargin(0.0, 0.0, 20.0, 20.0);
	if (fxAtlas == Cannon_SpineAtlasFX) return FMargin(0.0, 0.0, 0.0, 0.0);
	if (fxAtlas == Cannonlv2_SpineAtlasFX) return FMargin(-5.0, -5.0, -5.0, 0.0);
	if (fxAtlas == Rock_SpineAtlasFX) return FMargin(0.0, 0.0, 0.0, 0.0);
	if (fxAtlas == Shoot_SpineAtlasFX) return FMargin(0.0, 0.0, 0.0, 0.0);
	if (fxAtlas == FireArrow_SpineAtlasFX) return FMargin(-5.0, -5.0, 10.0, 10.0);
	if (fxAtlas == HeavyCurveSlash_SpineAtlasFX) return FMargin(-10.0, -20.0, -20.0, 0.0);
	if (fxAtlas == Stab_SpineAtlasFX) return FMargin(0.0, 0.0, 0.0, 0.0);
	if (fxAtlas == LongGun_SpineAtlasFX) return FMargin(-10.0, -20.0, -20.0, 0.0);
	if (fxAtlas == Slash_SpineAtlasFX) return FMargin(0.0, 0.0, 0.0, 0.0);
	if (fxAtlas == Smash_SpineAtlasFX) return FMargin(0.0, 0.0, 0.0, 0.0);
...
FSpineAsset UAssetLoaderComponent::GetSpine(CardEnum cardEnum)
{
	...
	auto makeAsset = [&](USpineAtlasAsset* atlas, USpineSkeletonDataAsset* data, USpineAtlasAsset* atlas_fx, USpineSkeletonDataAsset* data_fx, FMargin padding)
	{
		FSpineAsset asset;
		asset.atlas = atlas;
	...
	switch(cardEnum)
	{
	case CardEnum::Archer: return makeAsset(Archer_SpineAtlas, Archer_SpineData, Arrow_SpineAtlasFX, Arrow_SpineDataFX, FMargin(0.0, 0.0, 0.0, 0.0));
	case CardEnum::Artillery: return makeAsset(Artillery_SpineAtlas, Artillery_SpineData, Cannonlv2_SpineAtlasFX, Cannonlv2_SpineDataFX, FMargin(0.0, 19.0, 0.0, 0.0));
	case CardEnum::Battleship: return makeAsset(Battleship_SpineAtlas, Battleship_SpineData, Cannonlv2_SpineAtlasFX, Cannonlv2_SpineDataFX, FMargin(0.0, 0.0, 0.0, 0.0));

	case CardEnum::Cannon: return makeAsset(Cannon_SpineAtlas, Cannon_SpineData, Cannon_SpineAtlasFX, Cannon_SpineDataFX, FMargin(0.0, 16.0, 0.0, 0.0));
	case CardEnum::Catapult: return makeAsset(Catapult_SpineAtlas, Catapult_SpineData, Rock_SpineAtlasFX, Rock_SpineDataFX, FMargin(0.0, 14.0, 0.0, 0.0));
	case CardEnum::Conscript: return makeAsset(Conscript_SpineAtlas, Conscript_SpineData, Shoot_SpineAtlasFX, Shoot_SpineDataFX, FMargin(0.0, 8.0, 0.0, 0.0));

	case CardEnum::Frigate: return makeAsset(Frigate_SpineAtlas, Frigate_SpineData, Cannon_SpineAtlasFX, Cannon_SpineDataFX, FMargin(0.0, 0.0, 0.0, 0.0));
	case CardEnum::Galley: return makeAsset(Galley_SpineAtlas, Galley_SpineData, FireArrow_SpineAtlasFX, FireArrow_SpineDataFX, FMargin(0.0, 0.0, 0.0, 0.0));
	case CardEnum::Infantry: return makeAsset(Infantry_SpineAtlas, Infantry_SpineData, Shoot_SpineAtlasFX, Shoot_SpineDataFX, FMargin(0.0, 11.0, 0.0, 0.0));

	case CardEnum::Knight: return makeAsset(Knight_SpineAtlas, Knight_SpineData, HeavyCurveSlash_SpineAtlasFX, HeavyCurveSlash_SpineDataFX, FMargin(0.0, 0.0, 0.0, 0.0));
	case CardEnum::MachineGun: return makeAsset(MachineGun_SpineAtlas, MachineGun_SpineData, Shoot_SpineAtlasFX, Shoot_SpineDataFX, FMargin(0.0, 28.0, 0.0, 0.0)); // 28
	case CardEnum::Militia: return makeAsset(Militia_SpineAtlas, Militia_SpineData, Stab_SpineAtlasFX, Stab_SpineDataFX, FMargin(0.0, 7.0, 0.0, 0.0)); // 10
	case CardEnum::Musketeer: return makeAsset(Musketeer_SpineAtlas, Musketeer_SpineData, LongGun_SpineAtlasFX, LongGun_SpineDataFX, FMargin(0.0, 7.0, 0.0, 0.0));
	case CardEnum::Swordsman: return makeAsset(Swordsman_SpineAtlas, Swordsman_SpineData, Slash_SpineAtlasFX, Slash_SpineDataFX, FMargin(0.0, 8.0, 0.0, 0.0));
	case CardEnum::Tank: return makeAsset(Tank_SpineAtlas, Tank_SpineData, Cannonlv2_SpineAtlasFX, Cannonlv2_SpineDataFX, FMargin(0.0, 6.0, 0.0, 0.0));
	case CardEnum::Warrior: return makeAsset(Warrior_SpineAtlas, Warrior_SpineData, Smash_SpineAtlasFX, Smash_SpineDataFX, FMargin(0.0, 8.0, 0.0, 0.0));

	case CardEnum::Wall: return makeAsset(StoneWall_SpineAtlas, StoneWall_SpineData, nullptr, nullptr, FMargin(0.0, 0.0, 0.0, 0.0));
	case CardEnum::RaidTreasure: return makeAsset(RaidTreasure_SpineAtlas, RaidTreasure_SpineData, nullptr, nullptr, FMargin(0.0, 0.0, 0.0, 0.0));

	default:
		UE_DEBUG_BREAK();
		return makeAsset(Archer_SpineAtlas, Archer_SpineData, Arrow_SpineAtlasFX, Arrow_SpineDataFX, FMargin(0.0, 0.0, 0.0, 0.0));
	}
}