...
DECLARE_LOG_CATEGORY_EXTERN(PunLogAsset, Log, NoLogging);
DECLARE_LOG_CATEGORY_EXTERN(PunLogAssetLean, Log, NoLogging);
...
DECLARE_LOG_CATEGORY_EXTERN(PunBuilding, Log, Log);
...
DECLARE_LOG_CATEGORY_EXTERN(PunInput, Log, Log);
