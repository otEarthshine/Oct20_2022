...
FoundResourceHolderInfos ResourceTypeHolders::FindHolder(ResourceFindType type, int32 amount, WorldTile2 origin, std::vector<int32> avoidIds, int32 maxFloodDist) const
{
